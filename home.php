	...
	<div class="navbar navbar-default navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<!-- Trigger the modal with a button -->
				<li><a  href="#" data-toggle="modal" data-target="#SignIn"><span class="glyphicon glyphicon-user"></span>SignIn</a></li>
			</ul>
		</div>
	</div>
</div>
...
<p><br/></p>
<!--SignIn Modal -->
<div id="SignIn" class="modal fade" role="dialog" tabindex="-1" style="margin-top:15%;">
<div class="modal-dialog modal-sm">

   <!-- Modal content-->
    <div class="modal-content">
      	<div class="modal-header"  style="background: #5a0800;color:#ffffff;">
      		<h4 class="modal-title" align="center">LogIn
      	...
      	<div class="modal-body" style="background: #eeeeee;">
			...
			<br>
			<a href="#" style="list-style:none;font-size:10px;">Forgotten Password</a>
			<button type="button" class="btn btn-danger" data-dismiss="modal" style="float:right;color:#ffffff;">Close</button>
			<input type="submit" value="LogIn" class="btn" style="float:right;margin-right:5px;background: #5a0800;color:#ffffff;">
			</form>
      	</div>
      	<div id="e_msg" style="padding-left:15px;"></div>
